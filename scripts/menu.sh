...
chrome="^bg(black)^fg(blue)^p(+10)^i(confs/xbm8x8/fs_01.xbm) Chrome ^p(+62)"
home="^bg(black)^fg(lightblue)^p(+10)^i(confs/xbm8x8/pacman.xbm) Home ^p(+62)"
...
dzen="dzen2 -fn $terminus -x 0 -y 880 -w 80 -h 20 -l 4 -m -p"
